...
Company metadata and credential contract for **Mizrahi Bank**.

> **Note.** `username` is your **ID number**.
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"mizrahi","username":"my-username","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
