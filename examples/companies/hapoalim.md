...
Company metadata and credential contract for **Bank Hapoalim**.
...
|---|---|---|
| `userCode` | yes | User code / login code. |
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"hapoalim","userCode":"AB12345","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
