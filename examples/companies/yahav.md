...
Company metadata and credential contract for **Bank Yahav**.

> **Note.** Requires both `username` and your `nationalID`.
...
| `nationalID` | yes | National ID number. |
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"yahav","username":"my-username","nationalID":"012345678","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
