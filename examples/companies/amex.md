...
Company metadata and credential contract for **Amex**.

> **Note.** `card6Digits` is the last 6 digits of your card.
...
| `card6Digits` | yes | Last 6 digits of the card (exactly 6). |
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"amex","id":"012345678","card6Digits":"123456","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
