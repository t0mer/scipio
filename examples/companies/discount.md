...
Company metadata and credential contract for **Discount Bank**.
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"discount","id":"012345678","password":"your-password","num":"123"},"options":{"startDate":"2024-01-01"}}'
```
