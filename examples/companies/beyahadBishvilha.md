...
Company metadata and credential contract for **Beyahad Bishvilha**.
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"beyahadBishvilha","id":"012345678","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
