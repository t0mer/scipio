...
Company metadata and credential contract for **Visa Cal**.
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"visaCal","username":"my-username","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
