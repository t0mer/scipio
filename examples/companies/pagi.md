...
Company metadata and credential contract for **Pagi**.
...
curl -sS -X POST http://localhost:8080/api/v1/scrape \
  ...
  -d '{"credentials":{"companyId":"pagi","username":"my-username","password":"your-password"},"options":{"startDate":"2024-01-01"}}'
```
